...
class Messages(object):
    ...
    def send(self, message, async_send=False, ip_pool=None, send_at=None):
        ...
        Raises:
           ...
           Error: A general Mandrill error has occurred
        """
        _params = {'message': message, 'async': async_send, 'ip_pool': ip_pool, 'send_at': send_at}
        return self.master.call('messages/send', _params)

    def send_template(self, template_name, template_content, message, async_send=False, ip_pool=None, send_at=None):
        ...
        Raises:
           ...
           Error: A general Mandrill error has occurred
        """
        _params = {'template_name': template_name, 'template_content': template_content, 'message': message, 'async': async_send, 'ip_pool': ip_pool, 'send_at': send_at}
    ...
    def send_raw(self, raw_message, from_email=None, from_name=None, to=None, async_send=False, ip_pool=None, send_at=None, return_path_domain=None):
        ...
        Raises:
           ...
           Error: A general Mandrill error has occurred
        """
        _params = {'raw_message': raw_message, 'from_email': from_email, 'from_name': from_name, 'to': to, 'async': async_send, 'ip_pool': ip_pool, 'send_at': send_at, 'return_path_domain': return_path_domain}
